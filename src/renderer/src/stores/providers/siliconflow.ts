...
export const siliconflowPreset: BuiltinProviderPreset = {
  ...
  defaultModels: [
    ...
    { id: 'Qwen/Qwen3-8B', name: 'Qwen3 8B', icon: 'qwen', enabled: true, contextLength: 131_072, maxOutputTokens: 32_768, supportsVision: false, supportsFunctionCall: true, inputPrice: 0.05, outputPrice: 0.4, supportsThinking: true, thinkingConfig: { bodyParams: { enable_thinking: true } } },
    // ── GLM (智谱) ──
    ...
    // ── Moonshot / Kimi ──
    { id: 'moonshotai/Kimi-K2.5', name: 'Kimi K2.5', icon: 'kimi', enabled: true, contextLength: 262_144, maxOutputTokens: 8_192, supportsVision: true, supportsFunctionCall: true, inputPrice: 0.23, outputPrice: 3.0 },
    ...
    // ── OpenAI (开源) ──
    { id: 'openai/gpt-oss-120b', name: 'GPT-OSS 120B', icon: 'openai', enabled: true, contextLength: 131_072, maxOutputTokens: 16_384, supportsVision: false, supportsFunctionCall: true, inputPrice: 0.039, outputPrice: 0.19 },
    { id: 'openai/gpt-oss-20b', name: 'GPT-OSS 20B', icon: 'openai', enabled: true, contextLength: 131_072, maxOutputTokens: 16_384, supportsVision: false, supportsFunctionCall: true, inputPrice: 0.03, outputPrice: 0.14 },
    // ── 其他 ──
